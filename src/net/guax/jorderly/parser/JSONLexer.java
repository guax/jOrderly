...
public class JSONLexer extends Lexer {
    ...
    public final void mINT() throws RecognitionException {
        try {
            // JSON.g:43:14: ( ( '-' | '+' )? ( DIGIT | '1' .. '9' ( DIGIT )+ ) )
            // JSON.g:43:16: ( '-' | '+' )? ( DIGIT | '1' .. '9' ( DIGIT )+ )
            {
            // JSON.g:43:16: ( '-' | '+' )?
            int alt1=2;
    ...
    public final void mEXP() throws RecognitionException {
        try {
            // JSON.g:45:14: ( ( 'e' | 'E' ) ( '+' | '-' )? ( DIGIT )+ )
            // JSON.g:45:16: ( 'e' | 'E' ) ( '+' | '-' )? ( DIGIT )+
            {
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JSON.g:52:5: ( INT ( FRAC )? ( EXP )? )
            // JSON.g:52:7: INT ( FRAC )? ( EXP )?
            {
            mINT(); 
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // JSON.g:68:9: ( '\\\\' ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) )
            // JSON.g:68:13: '\\\\' ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
            {
            match('\\'); 

            // JSON.g:68:18: ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
            int alt9=9;
            switch ( input.LA(1) ) {
            case 'u':
                {
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // JSON.g:72:5: ( 'u' HexDigit HexDigit HexDigit HexDigit )
            // JSON.g:72:7: 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('u'); 
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JSON.g:87:9: ( '\"' ( EscapeSequence |~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )* '\"' )
            // JSON.g:88:5: '\"' ( EscapeSequence |~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )* '\"'
            {
            match('\"'); 

            // JSON.g:88:9: ( EscapeSequence |~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )*
            loop11:
            do {
                int alt11=3;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JSON.g:92:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | DIGIT ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | DIGIT )* )
            // JSON.g:92:7: ( 'a' .. 'z' | 'A' .. 'Z' | DIGIT ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | DIGIT )*
            {
